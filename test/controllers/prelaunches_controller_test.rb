...
class PrelaunchesControllerTest < ActionController::TestCase
  ...
  test "should create prelaunch" do
    assert_difference('Prelaunch.count') do
      post :create, prelaunch: { code: @prelaunch.code, commentaire: @prelaunch.commentaire, count: @prelaunch.count, email: @prelaunch.email }
    end
  ...
  test "should update prelaunch" do
    patch :update, id: @prelaunch, prelaunch: { code: @prelaunch.code, commentaire: @prelaunch.commentaire, count: @prelaunch.count, email: @prelaunch.email }
    assert_redirected_to prelaunch_path(assigns(:prelaunch))
  end
